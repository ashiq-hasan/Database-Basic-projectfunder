...
<div class="wrapper">
    ...
    <div class = "Profilbox">
            ...
            <div class ="Projekt"><h2>"Name des Projekts"</h2></div>
                <a href="#" id = "ProjektE"><h4>"Name des Projekterstellers"</h4></a> <br>
    ...
    <input id = "Editieren" class="button" type = "submit" name="" value="Projekt Editieren">
    <br>
    <p class = Abstand2> </p>
    ...
    <div style = "float:right;" id ="Ebutton" >
        <input id = "Kommentieren" class="button" type ="button" name="" value = "Kommentieren">
    </div><br>
